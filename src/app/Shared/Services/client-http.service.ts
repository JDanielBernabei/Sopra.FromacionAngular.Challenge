...
export class ClientHttpService {
  ...
  public getPopularMovies(): Observable<DiscoverMoviesApiResponse>{
  ...
  public getPopularSeries(): Observable<DiscoverSeriesApiResponse>{
    let queryParams = new HttpParams();
    queryParams = queryParams.append("api_key", this.apiKey);
    let newDate = new Date();
    newDate.setMonth(newDate.getMonth() - 3);
  ...
  public getMoviesByQuery(stringBusqueda: string): Observable<SearchMoviesApiResponse>{
    let queryParams = new HttpParams();
    queryParams = queryParams.append("api_key", this.apiKey);
  ...
  public getShowsByQuery(stringBusqueda: string): Observable<SearchSeriesApiResponse>{
    let queryParams = new HttpParams();
    queryParams = queryParams.append("api_key", this.apiKey);
    queryParams = queryParams.append("query", stringBusqueda);
